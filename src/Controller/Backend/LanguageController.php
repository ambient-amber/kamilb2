...
class LanguageController extends AbstractController
{
    ...
    {
        return $this->render('backend/language/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('backend/language/new.html.twig', [
            'language' => $language,
    ...
    {
        return $this->render('backend/language/show.html.twig', [
            'language' => $language,
        ]);
    }
    ...
    public function edit(Request $request, Language $language): Response
    {
        ...
        return $this->render('backend/language/edit.html.twig', [
            'language' => $language,
            'form' => $form->createView(),
        ]);
    }
